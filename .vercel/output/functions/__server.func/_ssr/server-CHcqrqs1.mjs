...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CQxzkV--.mjs");
...
var manifest = { "d9d4df982eacc651d4fd322a35cfb20f4d7ad42c68b02708f8c5e881c272db91": {
	functionName: "getLeetCodeStats_createServerFn_handler",
	importer: () => import("./leetcode.functions-YogMaVjO.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-7K75Q5oN.mjs").then((n) => n.t),
		import("./start-D5QzWxER.mjs"),
